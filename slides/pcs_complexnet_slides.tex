...
\begin{frame}{Inverse problem}
    ...
    This is called an \alert{inverse problem}.
\end{frame}
...
\begin{frame}{Inverse problem}
    ...
    \begin{itemize}
        ...
        \item Perform inference over the dataset: in particular we will study
            its \alert{correlation matrix} and the \alert{mean field
...
\begin{frame}{Correlations}
    ...
    \begin{equation}
        C_{ij} = \expval{\sigma_i \sigma_j}_m - \expval{\sigma_i}
        \expval{\sigma_j}
    \end{equation}
